...
def func13():
    ...
    "timesnewroman", 9), activebackground="palegreen", activeforeground="red").place(x=8, y=700)
    sbmibtn = Button(screen2, text='Create',command=create8,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=170)
    sbmibtn = Button(screen2, text='bank accounts',command=create8,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665, 
    y=200)
    e11 = Entry(screen2,).place(x=710, y=100)
    sbmibtn = Button(screen2, text='bank OCC a/c',command=create8,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=220)
    sbmibtn = Button(screen2, text='bank ODD',command=create8,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665, 
    y=200)
    sbmibtn = Button(screen2, text='branch / division',command=create8,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=220)
    sbmibtn = Button(screen2, text='Capital accounts',command=create8,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665, 
    y=200)
    sbmibtn = Button(screen2, text='Profit & loss A/C',command=create8,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=220)
